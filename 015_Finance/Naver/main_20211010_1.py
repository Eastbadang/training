...
req = requests.get("https://finance.naver.com/sise/sise_market_sum.nhn?sosok=0&page=1")
html = req.text
soup = bs(html, "lxml")
# print(soup)  # 데이터 확인
...
for stockContent in stockContents:
    try:
        ...
        print(f"{stockRank}등 {stockName} 종목의 현재가는 {stockPrice}원이고, 시가총액은 {stockCap}억 원 입니다.")
        # print(stockRank)
        # print(stockName)
        # print(stockPrice)
        # print(stockCap)
