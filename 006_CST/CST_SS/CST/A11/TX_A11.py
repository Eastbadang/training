...
job1 = cst.interface.DesignEnvironment.new_ems(mycst,w"C:/Works/PycharmProjects/PY36/CST/A11/TX_COIL_A11.cst")



# #define fitness function
# def cst_fun(x):
#     #I want to use Nelder-Mead algorithm for optimization. However, it doesn’t have bounds in
#     # SciPy. So, I define the bounds by myself although it is a bad idea.
#     if 30.0<=x[0]<=70.0 and 20.0<=x[1]<=35.0:
#         mycst = cst.interface.DesignEnvironment() #open CST
#         mycst1=cst.interface.DesignEnvironment.open_project(mycst, r"C:/Works/PycharmProjects/PY36/CST/PhasedArray_1 theta=0.cst") #open CST project, that will be optimized at 0deg.
...
#         #get S11
#         project = cst.results.ProjectFile(r"C:/Works/PycharmProjects/PY36/CST/PhasedArray_1 theta=0.cst")
...
#         mycst1=cst.interface.DesignEnvironment.open_project(mycst, r"C:/Works/PycharmProjects/PY36/CST/PhasedArray_1 theta=45.cst")
...
#         project = cst.results.ProjectFile(r"C:/Works/PycharmProjects/PY36/CST/PhasedArray_1 theta=45.cst")
#         S11 = project.get_3d().get_result_item(r"1D Results\S-Parameters\S1,1")
#         res=np.array(S11.get_ydata())
